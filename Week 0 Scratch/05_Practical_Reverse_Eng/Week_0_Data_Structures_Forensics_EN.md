...
*   [hello0.sb3](./../src0/hello0.sb3): Static foundational block (`say [hello, world]`).
*   [hello1.sb3](./../src0/hello1.sb3): Interactive sensing prompt (`ask [What's your name?] and wait`).
*   [hello2.sb3](./../src0/hello2.sb3): Variable concatenation via the `join` operator (`say (join (hello, ) (answer))`).
...
### 📂 Direct Source File Links in `src0`:
*   [meow0.sb3](./../src0/meow0.sb3): Repetitive boilerplate execution (3 consecutive sound blocks).
*   [meow1.sb3](./../src0/meow1.sb3): Control flow looping structure `repeat (3)`.
*   [meow2.sb3](./../src0/meow2.sb3) & [meow3.sb3](./../src0/meow3.sb3): Procedural custom block definition (`define meow`).
*   [meow4.sb3](./../src0/meow4.sb3): The architectural summit; parameterized procedures (`define meow (n)`).
...
### 📂 Direct Source File Links in `src0`:
*   [pet0.sb3](./../src0/pet0.sb3): Active busy polling loop (`forever -> if touching mouse-pointer?`).
*   [pet1.sb3](./../src0/pet1.sb3): Intelligent hardware interrupt hook (`when video motion > 10`).
