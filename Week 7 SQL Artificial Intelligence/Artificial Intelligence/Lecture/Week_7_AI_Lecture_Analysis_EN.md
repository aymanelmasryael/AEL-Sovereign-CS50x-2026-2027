# AEL CS Encyclopedia™ – Week 7 AI Subsystem: Lecture Analysis (EN)
...
## 👁️ Lecture Analysis: Large Language Models & Prompt Architecture
...
### 1. From Classical Logic to Probabilistic Generation
...
### 2. Prompt Architecture & System Constraints
...
*   **System Instructions (`System Prompts`)**: As demonstrated in the lecture file `chat3.py`, system instructions enforce rigorous architectural and persona guardrails on the model (`Limit your answer to one sentence. Pretend you're a cat.`), granting developers ultimate control over AI behavior before processing end-user input.
